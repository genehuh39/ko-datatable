...
ko.bindingHandlers.dataTable = {
    'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
        ...
        if (binding.columns && binding.columns.length) {
            ...
            if (binding.columns && binding.columns.length) {
                ...
                ko.utils.arrayForEach(binding.columns, function (col) {
                    ...
                    if (col.asSorting) {
                        options.aoColumns[theIndex].asSorting = col.asSorting;
                    }
                    if (col.sWidth) {
                        options.aoColumns[theIndex].sWidth = col.sWidth;
                    }
       ...
       if(binding.aaSorting) {
            options.aaSorting = binding.aaSorting;
       } 

       if(binding.bLengthChange) {
            options.bLengthChange = binding.bLengthChange;
       }
       if(binding.bProcessing) {
